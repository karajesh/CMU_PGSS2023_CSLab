library(readr)
iris <- read_csv("/Users/kamyarajesh/PGSS_CS_Lab/CMU_PGSS2023_CSLab/Week01/iris.csv", 
...
# Generate ggplot diagram to visualize a boxplot of Sepal.Width by Species and write this plot out to an image  # nolint
...
save_plot("/Users/kamyarajesh/PGSS_CS_Lab/CMU_PGSS2023_CSLab/Week01/iris.png", p1, base_height=4, base_width=4, limitsize=FALSE)