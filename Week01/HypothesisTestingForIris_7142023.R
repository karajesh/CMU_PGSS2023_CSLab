...
iris_df <- read_csv("PGSS2023_7142023/iris.csv", col_names = c("Petal.Length", "Petal.Width", "Sepal.Length", "Sepal.Width", "Species"))
...
# Perform ANOVA - to establish dif in species base don Petal.Length
...
wilcox.test(iris_df$Petal.Length[iris_df$Species == "Iris-versicolor"], iris_df$Petal.Length[iris_df$Species == "Iris-versicolor"])
